...
public:
    ...
    enum class Number : uint8_t {
        ...
        DRAWSTAR  =    27,  // 五角星航线模式。 注意，随着官方固件版本的更新，这里最新的模式数字已经增加到了27，因此仿真时用“mode 27”来切到此模式
    };
...
public:
    ...
    bool has_user_takeoff(bool must_navigate) const override { return false; }   //不允许在此模式下直接起飞（必须是在空中切换到此模式）
